...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <form class="form-inline" action="/action_page.php">
      <a href="../admin/order.php" style="">BACK</a>
    </form>
  </nav>
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-6 mt-3 bg-info p-4 rounded">
        ...
        <h4 class="text-light">FullName : <?= $vname; ?></h4>
        <h4 class="text-light">Card : <?= $vcard; ?></h4>
        <h4 class="text-light">Email : <?= $vemail; ?></h4>
        <h4 class="text-light">Phone : <?= $vphone; ?></h4>
        <h4 class="text-light">Address : <?= $address; ?></h4>
        <h4 class="text-light">Productname : <?= $vproductname; ?></h4>
